...
/* harmony import */ var _components_barba_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/barba.js */ "./src/js/components/barba.js");
...
/* harmony export */   gradientWipeEnter: () => (/* binding */ gradientWipeEnter),
/* harmony export */   gradientWipeLeave: () => (/* binding */ gradientWipeLeave)
/* harmony export */ });
...
const gradientWipeEnter = (element, duration = 1000, step = 50) => {
...
const gradientWipeLeave = (element, duration = 1000, step = 10) => {
  const start = performance.now();
  function animate(time) {
    const progress = Math.min((time - start) / duration, 1);
...
/* harmony import */ var _animation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animation.js */ "./src/js/components/animation.js");
/* harmony import */ var _header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header.js */ "./src/js/components/header.js");
/* harmony import */ var _stretch_text_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stretch-text.js */ "./src/js/components/stretch-text.js");
...
_barba_core__WEBPACK_IMPORTED_MODULE_0__.init({
  ...
  transitions: [{
    ...
    leave(data) {
      ...
      (0,_header_js__WEBPACK_IMPORTED_MODULE_2__.destroyHeader)();
      container.classList.add('is-animate');
      (0,_animation_js__WEBPACK_IMPORTED_MODULE_1__.gradientWipeLeave)(container, ANIMATION_DURATION);
      setTimeout(() => {
        done();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   destroyHeader: () => (/* binding */ destroyHeader),
...
/***/ "./src/js/components/stretch-text.js":
/*!*******************************************!*\
  !*** ./src/js/components/stretch-text.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   destroyStretchText: () => (/* binding */ destroyStretchText),
/* harmony export */   initStretchText: () => (/* binding */ initStretchText)
/* harmony export */ });
const stretchText = () => {
...
const initStretchText = () => {
  stretchText();
  window.addEventListener('resize', stretchText);
};
const destroyStretchText = () => {
